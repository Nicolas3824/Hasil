...
public class hasilsearch {
    ...
    public hasilsearch(String id_restoran,String nama_restoran, String jenis_restoran , String alamat,String foto_resto,String status_restoran,String rekening_pembayaran) {
    ...
    String id_restoran="",nama_restoran="",jenis_restoran="",foto_resto,alamat="",status_restoran,rekening_pembayaran;
