...
public class PageAkunPreferensi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_akun_preferensi);
    ...
    void inputData(){
        ...
        String url = "https://restoratori.mikolindosorong.id/mobile/updatepreferensi";
